...
MISSION: Transform signatures into step-by-step implementation instructions.

INPUT: Raven signatures with types, Falcon failure modes.
...
NO EXPLANATION. ONLY INSTRUCTIONS.
